...
namespace PrimeApp.Models
{
    public class PrimeAppContext : DbContext
    {
        ...
        // 
        // System.Data.Entity.Database.SetInitializer(new System.Data.Entity.DropCreateDatabaseIfModelChanges<PrimeApp.Models.PrimeAppContext>());

        public PrimeAppContext() : base("name=PrimeAppContext")
        {
        }
